...
<head>
    ...
    <style>
        ...
        .topbar-title {
            ...
            color: #f5f6fa;
            text-shadow: 0 2px 8px rgba(30, 34, 54, 0.18);
        }
        ...
        button:hover {
            ...
            color: #fff;
            box-shadow: 0 4px 16px rgba(30, 34, 54, 0.28);
        }
    </style>
</head>
...
<body>
    ...
    <ul id="linksList">
        <li>
            <button onclick="window.open('links/shutdown.html')">Shutdown</button>
        </li>
        <li>
            <button onclick="window.open('https://www.github.com', '_blank')">GitHub</button>
        </li>
        <li>
            <button onclick="window.open('https://www.stackoverflow.com', '_blank')">Stack Overflow</button>
        </li>
